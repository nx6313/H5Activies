var Picker = (function () {
  ...
  var _defaults = {
    ...
    headRightBtnTxt: '确定',
    normalColor: '#FFF8A3',
    headLeftBtnColor: '#DFEF8B',
    headRightBtnColor: '#F9E70B',
    shadeClose: true,
    cancelFn: function () {},
    confirmFn: function () {},
    onChangeFn: function () {},
  ...
  var picker = {
    init: function () {
      ...
      if (!document.getElementById('pickerSelectWrap')) {
        ...
        pickerSelectWrap.style.background = '#ED6351';
        ...
        pickerSelectWrap.style.borderTop = '2px solid rgb(119, 5, 5)';
        pickerSelectWrap.style.boxShadow = '0 0 6px rgba(85, 6, 6, 0.8) inset';
        ...
        pickerHeaderWrap.style.background = '#EC533E';
